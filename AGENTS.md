# Monolith Skill — OpenCode Trigger

> **For OpenCode users.** This repo contains a drop-in AI skill under `.opencode/skills/monolith/`.
>
...
2. OpenCode automatically discovers `.opencode/skills/monolith/SKILL.md`.
...
- **Entry point:** `.opencode/skills/monolith/SKILL.md`
- **Master plan:** `.opencode/skills/monolith/plan.md`
- **User tutorial:** `.opencode/skills/monolith/TUTORIAL.md`
- **Quick start:** `.opencode/skills/monolith/QUICKSTART.md`
